...
public class SingleConstDeclPartList extends ConstDeclPartList {

    private ConstDeclPart ConstDeclPart;

    public SingleConstDeclPartList (ConstDeclPart ConstDeclPart) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("SingleConstDeclPartList(\n");
